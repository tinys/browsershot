(function(e, t) {
    ...
    b.Callbacks = function(e) {
        ...
        var n, r, i, o, a, s, u = [], l = !e.once && [], c = function(t) {
            ...
            fireWith: function(el, t) {
                return t = t || [], t = [ el, t.slice ? t.slice() : t ], !u || i && !l || (n ? l.push(t) : c(t)), this;
            },
            fire: function() {
...
PAK.register("module.createScreenLayer", function($) {
    ...
    that.showLayer = function(opt) {
        if (!_this.layer) {
            var w = $(document.body);
            _this.layer = $([ '<div style="padding:0;margin:0;border:0;position:absolute;z-index:9999;opacity:1;top:0px;height:0px;width:' + w.width() + "px;height:" + w.outerHeight() + 'px;display:hidden;">', "</div>" ].join(""));
        }
...
PAK.register("module.bindMoveLayer", function($) {
    return function(layer) {
        ...
        var shadowFlowMouse = function() {
            var begin = evtListener.begin, end = evtListener.end, startStart = evtListener.startState;
            var left = end.l - begin.l, top = end.t - begin.t, width = startStart.w, height = startStart.h;
...
PAK.register("module.createSelectArea", function($) {
    return function(opt) {
        ...
        var followMouse = function() {
            ...
            var width = end.l - start.l, height = end.t - start.t;
            style.width = width;
            style.height = height;
            if (height < 0) {
                style.top = end.t;
